...
export function CtaBanner() {
  ...
  return (
    <section className="relative bg-bg py-24 sm:py-32" id="cta-banner">
      <div className="mx-auto max-w-5xl px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-surface-high via-surface to-bg p-10 sm:p-16"
        >
          ...
          <div className="relative flex flex-col items-start gap-6">
            ...
            <h2 className="max-w-3xl font-display text-text-1 text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.02]">
              {t("title")}
            </h2>
